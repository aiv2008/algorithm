...
TreeNode* node_init(unsigned int data)
{
...
TreeNode* tree_search(TreeNode* root, unsigned int data)
{
	if(!root)return NULL;
    TreeNode* p = root;
    while( NIL != p->data)
...
TreeNode* tree_insert(TreeNode** ppRoot, unsigned int data)
{
...
TreeNode* tree_delete(TreeNode* root, unsigned int data)
{
