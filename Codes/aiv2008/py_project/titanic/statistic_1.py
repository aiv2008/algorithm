...
plt.title(u"乘客等级获救分布情况")
plt.xlabel(u"等级" )
plt.ylabel(u"获救情况（1 获救）" )
'''
...
sex_df = pd.DataFrame({u"死亡":sex_survived_0, u"获救":sex_survived_1})
sex_df.plot(kind="bar", stacked=True)
plt.title(u"性别获救情况分布")
plt.xlabel(u"性别")
plt.ylabel(u"密度")
